...
var KEYBOARD_MAP = [
  ...
  { type: "axis", index: 3, value: -1, code: "ArrowUp", label: "Right Stick: Up" },
  { type: "axis", index: 2, value: -1, code: "ArrowLeft", label: "Right Stick: Left" },
  { type: "axis", index: 3, value: 1, code: "ArrowDown", label: "Right Stick: Down" },
  { type: "axis", index: 2, value: 1, code: "ArrowRight", label: "Right Stick: Right" },
